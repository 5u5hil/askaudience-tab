        ...
        return {
            ...
            controller: ["$scope", "$ionicPopup", "$ionicPickerI18n", "$timeout", function(e, t, n, i) {
                ...
                function a() {
                    ...
                    e.isEnabled(t.getDate(), !0) ? o(t) : (e.year = l.year, e.month = l.month, e.day = l.day, e.hour = l.hour, e.minute = l.minute, e.second = l.second)
                }
                ...
                e.showPopup = function() {
                    t.show({
                        ...
                        title: e.title || "Pick " + (e.dateEnabled ? "a Date" : "") + (e.dateEnabled && e.timeEnabled ? " and " : "") + (e.timeEnabled ? " Time" : ""),
                        subTitle: e.subTitle || "",
                        scope: e,
                    ...
                    e.year = e.dateEnabled ? t.getFullYear() : 0, e.month = e.dateEnabled ? t.getMonth() : 0, e.day = e.dateEnabled ? t.getDate() : 0, e.hour = e.timeEnabled ? 23 : 0, e.minute = e.timeEnabled ? 59 : 0, e.second = e.secondsEnabled ? t.getSeconds() : 0, c()
                };
                var c = function() {
                        a();
                        var t = new Date(e.year, e.month, e.day, e.hour, e.minute, e.second);
