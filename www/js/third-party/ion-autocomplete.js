        ...
        return {
            ...
            link: function (scope, element, attrs, controllers) {
                ...
                var template = [
                    ...
                    '</label>',
                    '<div class="ion-autocomplete-loading-icon" ng-if="viewModel.showLoadingIcon"><ion-spinner icon="ios-small"></ion-spinner></div>',
                    ...
                    '<ion-item ng-if="false" ng-repeat="selectedItem in viewModel.selectedItems track by $index" class="item-icon-left item-icon-right item-text-wrap">',
                    ...
                    '</ion-item>',
                    '<ion-item ng-if="false" class="item-icon-left item-icon-right item-text-wrap">',
                    '<i class="icon ion-checkmark"></i>',
                    ...
                    '<ion-item collection-repeat="item in viewModel.searchItems" item-height="75px" item-width="100%" ng-click="viewModel.selectItem(item)" class="item-text-wrap search-items">',
                    '<img src="{{item.img?item.img:\'img/user-icon.png\'}}" class="profile-icon" />  {{viewModel.getItemValue(item, viewModel.itemViewValueKey)}}',
                    '</ion-item>',
                    '</ion-content>',
                    '</div>'
                ].join('');
